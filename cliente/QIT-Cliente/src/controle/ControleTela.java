 ...
 * @author Tiago
 */
public class ControleTela implements IControle {
    ...
    public Tela consultar(Tela tela) {
        Tela objLocal = new Tela();
        try {
            objLocal = dao.consultar(tela);
        } catch (Exception e) {
    ...
    public Object[][] popularTabela(JTable tabela, IModelo modelo, boolean isModal) {
     ...
     //   System.out.println("populando tabela");
        try {
            ...
            ArrayList<Tela> listaPredio = dao.listar(modelo);
