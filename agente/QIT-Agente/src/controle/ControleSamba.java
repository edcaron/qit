...
public class ControleSamba {
    ...
    private static final String SERVER = "qit-server";
    private static final String DOMAIN = SERVER;
    private static final String SHARED_FOLDER = "smb://" + SERVER + "/qit/";
    private static final String SOFTWARES_PATH = SHARED_FOLDER + "softwares/";
    private static final String SCRIPTS_PATH = SHARED_FOLDER + "scripts/";
//    private static final NtlmPasswordAuthentication AUTHENTICATION = new NtlmPasswordAuthentication(DOMAIN, USER, PASSWORD);
    private static final NtlmPasswordAuthentication AUTHENTICATION = new NtlmPasswordAuthentication(null);
     ...
     */
    public static boolean save(String nome, byte[] arquivo, int tipo, int id) {
     ...
     * @return true se deu certo
     */
    public static boolean exists(String caminho) {
        boolean retorno = false;
        try {
     ...
     * @return true se deu certo
     */
    public static boolean makeDir(String caminho) {
        boolean retorno = false;
        try {
     ...
     * @return true se deu certo
     */
    public static boolean delete(String nome, int tipo, int id) {
        boolean retorno = false;
        String caminhoArquivo = "";
